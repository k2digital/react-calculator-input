...
var _excluded = ["label", "labelPosition", "className"];
  ...
  _createClass(NumericInput, [{
    ...
    value: function render() {
      ...
      var _this$sanitizeRenderP = this.sanitizeRenderProps(props),
          ...
          className = _this$sanitizeRenderP.className,
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: (0, _classnames["default"])('numeric-input-component', className)
        ...
        ref: this.calcRef,
        className: (0, _classnames["default"])('calculator-wrapper', {
